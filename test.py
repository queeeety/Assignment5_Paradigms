...
if __name__ == "__main__":
    ...
    tests = [
        {"input": "max(min(2+3,5+6), 7*(8-2)) + 5", "expected_output": "47"},
    ...
    for test in tests:
        ...
        if error:
            ...
            print(f"Test: {test['input'].strip()} \033[4mpassed\033[0m.")
        else:
            print(f"Test: {test['input'].strip()} \033[1mfailed\033[0m. Expected '{test['expected_output']}', got '{output}'")